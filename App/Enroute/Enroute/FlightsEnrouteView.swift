...
extension FlightSearch {
    var predicate: NSPredicate {
        ...
        // SuperClass de Airport, Flight, Airline, usado por CoreData
        ...
        // Predicate con muchas variables y condiciones
        return NSPredicate(format: format, argumentArray: args)
    }
}

struct FlightsEnrouteView: View {
    // Obtener el Conteexto de esta vista para poder usarlo en otra vista
    ...
    var filter: some View {
        ...
        .sheet(isPresented: $showFilter) {
            ...
            // Hay que pasarle el mismo contexto de CoreData a esta vista nueva
        }
    }
...
struct FlightList: View {
    // Obtener valores desde CoreData.
    // El resultado es una Collection

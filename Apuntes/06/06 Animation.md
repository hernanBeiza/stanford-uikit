...
### Implícitamente vs Explícitamente

#### Implícitamente

- Automatic no es la forma primaria
- Son usadas en vistas independientes generalmente
  - En vistas contenedoras, las animación son pasadas hacia las vistas hijas
...
- Son usadas en 
  - Intents
  - En cambios sobre la UI, como al entrar en modo de edición
